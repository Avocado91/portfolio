      ...
      projects: [
        {
          ...
          description:
            "This app is your every-day, standard to-do app with a twist. Built with React this app will actually              randomly select one of your options that you've added when clicking the button. This was the first app I built using React so I was focused on learning the basics to get a solid foundation of React. Feel free to check       out this app on Github or see the live demo.",
